...
Outils internes, applications web, interfaces métier, APIs, automatisations, prototypes techniques, jusqu'aux applications GUI.\
J'aborde chaque demande de la même manière : *comprendre* le besoin, proposer une *solution*, puis *livrer* quelque chose d’utilisable, esthétique et fonctionnel.
...
<h3 align="center">Base de données & ORM</h3>
